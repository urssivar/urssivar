<template>
  <div
    ...
    <img src="/stamp-logo.svg" alt=""
      class="absolute top-0 left-0 block w-full invert dark:invert-0 select-none pointer-events-none rotate-[15deg] group-hover:rotate-0 group-active:rotate-0 transition-transform duration-300 ease-out"
      aria-hidden="true" draggable="false">
  </div>
</template>
