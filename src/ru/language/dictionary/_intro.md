...
5,171 лексем · БД 20.05.2025 · документ 13.12.2025 · лицензия [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.ru) {.text-sm .italic}
...
_Примечание: хотя /o/ технически является позиционным вариантом /ʷa/, его трактовка как отдельной фонемы значительно упрощает письмо._
...
### Навигация по словарю {#dictionary-navigation}
