...
{{ total }} статей · база данных 21.06.2026 · документ 19.06.2026 · лицензия [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.ru)
:::
...
Каждая статья включает заглавную форму, грамматические теги и определения. Грамматические формы приводятся там, где необходимо. Определения могут содержать примечания и примеры употребления. Некоторые статьи также включают примечание к слову и этимологию. При наличии даются "производное от" («), диалектные варианты (=) и "см. также" (+).
