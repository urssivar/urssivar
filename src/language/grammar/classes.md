...
- **урши ==в==ейкку** "there's no boy"
- **рицци ==р==егур** "sister left"
- **==б==уҡен ҳуне** "the long road"
...
- **нисса ==д==ирьид** "we can"
- **нишша ==д==ирьитта** "you (pl.) can"
...
- **а==д==еркун** "not eaten"  
  _object plural, i.e. the apples_
- **==б==ужив** "stayed"  
  _human plural, i.e. the kids_
